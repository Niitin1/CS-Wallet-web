...
export class Step7Component implements OnInit {
  ...
  tranFieldsBytesBase58: string = ''; // TODO delete
...
The required result is a signatureBase58 signed with a secret key
 ...
 */
  ...
  ngOnInit() {
    ...
    this.dataService.refreshBalance(this.dataService.currencyCode); //balance update
    ...
    console.log("signatureBase58 = " + signedMessage);
    this.signatureBase58 = this.base58.encode(signedMessage);
    this.tranFieldsBytesBase58 = this.base58.encode(buffer);
  ...
  public goToStep(step : number) {
    ...
    if (step == 8) {
      this.dataService.generateTransaction(
        ...
        this.signatureBase58,
        this.dataService.offeredMaxFee,
        this.tranFieldsBytesBase58
      ).subscribe(
        data =>  {
